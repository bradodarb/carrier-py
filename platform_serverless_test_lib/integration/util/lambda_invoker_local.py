...
from platform_serverless_test_lib.integration.util.event_to_request import (VERB_GET,
                                                                        VERB_POST, VERB_PUT,
                                                                        VERB_PATCH, VERB_DELETE)
from platform_serverless_test_lib.integration.util.event_to_request import (update_request_event,
...
from platform_serverless_test_lib.integration.util.mock_constants import (MOCK_TOKEN,
                                                                      MOCK_ACCOUNT_ID)
