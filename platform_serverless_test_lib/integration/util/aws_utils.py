from platform_serverless_test_lib.integration.cognito.cognito_client import (CognitoUserClient,
...
def get_cognito_id_token(service_name, region, ssm_client):
    ...
    :return: JWT 'IdToken'
    """
    pool_id_response = ssm_client.get_parameter(Name='/cognito/platform/user_pool_id')
    app_id_response = ssm_client.get_parameter(Name='/cognito/platform/web_client_id')
