...
KEY = $(shell aws --profile platform configure get aws_access_key_id)
SECRET = $(shell aws --profile platform configure get aws_secret_access_key)
REGION = $(shell aws --profile platform configure get region)
